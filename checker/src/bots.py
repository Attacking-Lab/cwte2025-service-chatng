...
template_bot_calculator = {
    "init": [
        {
            ...
            "actions": [
                [
                    "print",
                    "Hello! How can I help you? Say `calculator` to enable my specialized mode!",
                    False,
                ]
            ],
        },
        {"match": "(goodbye|bye|see you|later)", "actions": [["print", "Bye!", False]]},
        {
            "match": "(thanks|thanx|thank ?you)",
            "actions": [["print", "No problem!", False]],
        },
        {
            "match": "calculator",
            "actions": [
                [
                    "print",
                    "Calculator mode was enabled! Write `exit` to return to normal mode.",
                    False,
                ],
                ["goto", "calc"],
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "I didn't understand... Write `help` if you want more info about how to use my abilities.",
                    False,
                ]
            ],
        },
    ...
    "calc": [
        ...
        {
            "match": "exit",
            "actions": [["print", "Back to normal mode", False], ["goto", "init"]],
        },
    ],
}
    ...
    "init": [
        {
            ...
            "actions": [
                [
                    "print",
                    "Hello! How can I help you? Say `conversions` to enable my specialized mode!",
                    False,
                ]
            ],
        },
        ...
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "Conversions mode was enabled! Write `exit` to return to normal mode.",
                    False,
                ],
                ["goto", "conv"],
            ],
...
template_bot_negative = {
    "init": [
        {
            "match": "(hey|hello|hi|good ?morning|good ?afternoon|help)",
            "actions": [["print", "I don't want to talk to you", False]],
        },
        {
            "match": "(goodbye|bye|see you|later)",
            "actions": [["print", "It was about time...", False]],
        },
        {
            "match": "(thanks|thanx|thank ?you)",
            "actions": [["print", "For what?", False]],
        },
        {"match": "(help)", "actions": [["print", "Indeed... you need help.", False]]},
        {"match": ".*", "actions": [["print", "Nonsense...", False]]},
    ]
}
    ...
    "init": [
        {
            ...
            "actions": [
                [
                    "print",
                    "Ah yes, the Fort Knox of passwords: 1234. Truly groundbreaking.",
                    False,
                ]
            ],
        },
        ...
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "Ooo, SQL injection. So edgy. What's next, cross-site script kiddie?",
                    False,
                ]
            ],
        },
        ...
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "You type like someone who learned hacking from a 10-minute YouTube tutorial.",
                    False,
                ]
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "Nice attempt. Even my error logs have more creativity.",
                    False,
                ]
            ],
        },
        ...
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "Careful, with moves like that you'll end up as a sysadmin's inside joke.",
                    False,
                ]
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "That payload's so basic, it belongs in a freshman CS class.",
                    False,
                ]
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "You call that obfuscation? My grandma's Wi-Fi password is tougher.",
                    False,
                ]
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "Bold move. Did you copy that straight from Stack Overflow?",
                    False,
                ]
            ],
        },
        {
            ...
            "actions": [
                [
                    "print",
                    "That script runs slower than Windows Update on a toaster.",
                    False,
                ]
            ],
        },
